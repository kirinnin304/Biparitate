...
TEST(FastFourierTransform, simpleInterconnectedMatching) {
    std::vector<int> aSide;
    aSide.push_back(0);
    aSide.push_back(1);
    std::vector<int> bSide;
...
TEST(FastFourierTransform, imperfectMatching) {
    std::vector<int> aSide;
    aSide.push_back(0);
    aSide.push_back(1);
    std::vector<int> bSide;
...
TEST(FastFourierTransform, largeImBalancedMatching) {
    std::vector<int> aSide;
    aSide.push_back(0);
    aSide.push_back(1);
    std::vector<int> bSide;
...
TEST(FastFourierTransform, largeBalancedMatching) {
    std::vector<int> aSide;
    aSide.push_back(0);
    aSide.push_back(1);
    std::vector<int> bSide;
...
TEST(FastFourierTransform, massive) {
    std::vector<int> aSide;
    std::vector<int> bSide;
    aSide.push_back(0);
    aSide.push_back(1);
